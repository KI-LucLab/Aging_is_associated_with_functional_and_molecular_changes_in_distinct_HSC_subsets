...
colnames(df_raw_filtered)[c((length(basic)+1):(length(c(basic,rownames(annotation)))))] <- as.character(annotation$Short_name)
write.table(df_raw_filtered,
            file = "../output_files/ATACseq_analysis/mm10_allagegroups5YA_CD150hiandprog_macspeaks_tagdir_mergedPeaks_noadj_5RPKM_inCD49bposCD49bnegLMPPGMP.txt",
