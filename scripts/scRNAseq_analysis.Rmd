...
my_metadata$Age <- factor(case_when(my_metadata$plate %in% c("090s","091s","246s") ~ "YA", my_metadata$plate %in% c("092s","093s") ~ "Old", my_metadata$plate %in% c("ss2_22_126") ~ "Young"))
...
dat.seurat$Age <- factor(dat.seurat$Age, levels=c("Young","YA","Old"))
...
setEPS()
postscript("../plots/scRNAseq_analysis/scRNAseq_UMAP_Plate.eps", width = 8, height = 7)
  DimPlot(dat.seurat, reduction = "umap", group.by = "plate", shuffle = TRUE)
dev.off()

setEPS()
postscript("../plots/scRNAseq_analysis/scRNAseq_UMAP_Age.eps", width = 8, height = 7)
  DimPlot(dat.seurat, reduction = "umap", group.by = "Age", shuffle = TRUE, cols = colours_Age)
dev.off()

setEPS()
postscript("../plots/scRNAseq_analysis/scRNAseq_UMAP_CellType.eps", width = 8, height = 7)
  DimPlot(dat.seurat, reduction = "umap", group.by = "Cell_type", cols = colours_Celltypes, shuffle = TRUE)
dev.off()
```
...
data_norm_YvsOld <- cbind(ENSEMBL_ID,data_norm[,which(column_info %in% c("Young_CD49b-","Young_CD49b+","Old_CD49b-","Old_CD49b+"))])
my_colnames <- 1:(ncol(data_norm_YvsOld)-1) %>% paste0(.,"_",dat.seurat$Age[which(column_info %in% c("Young_CD49b-","Young_CD49b+","Old_CD49b-","Old_CD49b+"))]) %>% c("ENSEMBL",.)
colnames(data_norm_YvsOld) <- my_colnames

#Write out table
write.table(data_norm_YvsOld,
            file = paste0("../output_files/scRNAseq_analysis/scRNAseq_GSEAInput_OldvsYoung.txt"),
            quote = FALSE, sep = "\t", row.names = FALSE, col.names = TRUE)

write.table(t(dat.seurat$Age[which(column_info %in% c("Young_CD49b-","Young_CD49b+","Old_CD49b-","Old_CD49b+"))]),
            file = paste0("../output_files/scRNAseq_analysis/scRNAseq_GSEAPhenotype_OldvsYoung.txt"),
            quote = FALSE, sep = "\t", row.names = FALSE, col.names = FALSE)

rm(data_norm, data_norm_YvsOld, ENSEMBL_ID, my_colnames, column_info)
```
...
setEPS()
  postscript(paste0("../plots/scRNAseq_analysis/scRNAseq_UMAP_Spib_Expression_max3.eps"), width = 8, height = 7)
  print(FeaturePlot(dat.seurat, features = "Spib_expression_norm", cols = c("gray","red"), max.cutoff = 3))
dev.off()

my_genes <- c("Itga2","Slamf1","Flt3","Cd48","Fcgr2b","Fcgr3","Aldh1a1","Selp","Spi1","Irf1","Junb","Runx1")
for (i in my_genes) {
    print(FeaturePlot(dat.seurat, features = i, cols = c("gray","red")))
    setEPS()
      postscript(paste0("../plots/scRNAseq_analysis/scRNAseq_UMAP_",i,"_Expression.eps"), width = 8, height = 7)
      print(FeaturePlot(dat.seurat, features = i, cols = c("gray","red")))
    dev.off()
}
...
CD150hi$Age <- factor(CD150hi$Age, levels = c("Young","YA","Old"))
CD150hi$Age_Cell_type <- factor(CD150hi$Age_Cell_type, levels = c("Young_CD49b-","Young_CD49b+","YA_CD49b-","YA_CD49b+","Old_CD49b-","Old_CD49b+")) 

VlnPlot(CD150hi, features = "Spib_expression_norm", cols = colours_Age, group.by = "Age")
setEPS()
  postscript(paste0("../plots/scRNAseq_analysis/scRNAseq_ViolinPlots_Spib_Expression.eps"), width = 8, height = 7)
...
for (TF in c("Spi1","Irf1","Junb","Runx1")){
  ...
  print(p)
  setEPS()
    postscript(paste0("../plots/scRNAseq_analysis/scRNAseq_ViolinPlots_",TF,"_expression.eps"), width = 8, height = 7)
    print(p)
  dev.off()
}
```
...
## Find the genes that differ most between Young and Old HSCs
Figure 4b

```{r Diff_analysis_Young_Old_1}
dat.seurat.DA <- FindMarkers(CD150hi, ident.1 = "Young", ident.2 = "Old",
...
setEPS()
postscript("../plots/scRNAseq_analysis/scRNAseq_Heatmap_diffYvsO_Top50each_LRtest.eps", width = 12, height = 16)
  print(p)
dev.off()

write.table(DA.clusters.Up,
            file = paste0("../output_files/scRNAseq_analysis/scRNAseq_Up_in_young_padj0.01_logFC1.txt"),
            quote = FALSE, sep = "\t", row.names = TRUE, col.names = TRUE)
...
write.table(DA.clusters.top100,
            file = paste0("../output_files/scRNAseq_analysis/scRNAseq_Up_in_old_young_top100_padj0.01_logFC1.txt"),
            quote = FALSE, sep = "\t", row.names = TRUE, col.names = TRUE)
...
write.table(data_norm_top100,
            file = paste0("../output_files/scRNAseq_analysis/scRNAseq_Up_in_old_young_norm_top100_padj0.01_logFC1.txt"),
            quote = FALSE, sep = "\t", row.names = TRUE, col.names = TRUE)

rm(dat.seurat.DA, DA.clusters, DA.clusters.Up, DA.clusters.Down, DA.clusters.top100, p)
```

## Look at differential genes between CD49b+ and CD49b- (Young)

```{r Diff_analysis_Y}
CD150hi_Young <- subset(dat.seurat, Cell_type %in% c("CD49b-","CD49b+"))
CD150hi_Young <- subset(CD150hi_Young, Age == "Young")
Idents(CD150hi_Young) <- CD150hi$Cell_type

dat.seurat.DA <- FindMarkers(CD150hi_Young, ident.1 = "CD49b-", ident.2 = "CD49b+",
...
## Look at differential genes between CD49b+ and CD49b- (YA)

```{r Diff_analysis_A}
CD150hi_YA <- subset(dat.seurat, Cell_type %in% c("CD49b-","CD49b+"))
CD150hi_YA <- subset(CD150hi_YA, Age == "YA")
Idents(CD150hi_YA) <- CD150hi$Cell_type

dat.seurat.DA <- FindMarkers(CD150hi_YA, ident.1 = "CD49b-", ident.2 = "CD49b+",
                             test.use = "LR", latent.vars = "percent.mt", logfc.threshold = 1)
DA.clusters <- dat.seurat.DA[dat.seurat.DA$p_val_adj < 0.01,]
DA.clusters.Up <- DA.clusters[DA.clusters$avg_log2FC > 1,]
DA.clusters.Down <- DA.clusters[DA.clusters$avg_log2FC < -1,]
...
```{r}
rm(CD150hi_Young, CD150hi_YA, CD150hi_Old, dat.seurat.DA, DA.clusters, DA.clusters.Up, DA.clusters.Down)
```
...
setEPS()
  postscript(paste0("../plots/scRNAseq_analysis/scRNAseq_ViolinPlots_quiescence_cell_types.eps"), width = 8, height = 7)
...
setEPS()
  postscript(paste0("../plots/scRNAseq_analysis/scRNAseq_ViolinPlots_proliferation_cell_types.eps"), width = 8, height = 7)
...
Idents(CD150hi) <- CD150hi$Age
CD150hi$Age <- factor(CD150hi$Age, levels = c("Young","YA","Old"))
CD150hi$Age_Cell_type <- factor(CD150hi$Age_Cell_type, levels = c("Young_CD49b-","YA_CD49b-","Old_CD49b-","Young_CD49b+","YA_CD49b+","Old_CD49b+"))

VlnPlot(CD150hi, features = "quiescent1", group.by = "Age_Cell_type", cols = c(colours_Age, colours_Age))
setEPS()
  postscript(paste0("../plots/scRNAseq_analysis/scRNAseq_ViolinPlots_quiescence_HSC_age_cell_type.eps"), width = 8, height = 7)
...
setEPS()
  postscript(paste0("../plots/scRNAseq_analysis/scRNAseq_ViolinPlots_proliferation_HSC_age_cell_types.eps"), width = 8, height = 7)
...
# Mann-Whitney test
wilcox.test(dat.seurat$quiescent1[which(dat.seurat$Age_Cell_type == "Young_CD49b-")],
            dat.seurat$quiescent1[which(dat.seurat$Age_Cell_type == "Young_CD49b+")])
wilcox.test(dat.seurat$quiescent1[which(dat.seurat$Age_Cell_type == "YA_CD49b-")],
            dat.seurat$quiescent1[which(dat.seurat$Age_Cell_type == "YA_CD49b+")])
...
wilcox.test(dat.seurat$proliferation1[which(dat.seurat$Age_Cell_type == "Young_CD49b-")],
            dat.seurat$proliferation1[which(dat.seurat$Age_Cell_type == "Young_CD49b+")])
wilcox.test(dat.seurat$proliferation1[which(dat.seurat$Age_Cell_type == "YA_CD49b-")],
            dat.seurat$proliferation1[which(dat.seurat$Age_Cell_type == "YA_CD49b+")])
...
setEPS()
  postscript(paste0("../plots/scRNAseq_analysis/scRNAseq_ViolinPlots_KEGG_adhesion_HSC_age.eps"), width = 8, height = 7)
  print(VlnPlot(CD150hi, features = "Adhesion_molecules1", group.by = "Age_Cell_type", cols = c(colours_Age, colours_Age), pt.size = 1))
dev.off()

CD150hi$Age_Cell_type2 <- factor(CD150hi$Age_Cell_type, levels = c("Young_CD49b-","Young_CD49b+","YA_CD49b-","YA_CD49b+","Old_CD49b-","Old_CD49b+"))

VlnPlot(CD150hi, features = "Itgb1", group.by = "Age_Cell_type2", cols = c("#DCBF30", "#9E1F19", "#DCBF30", "#9E1F19" ,"#DCBF30", "#9E1F19"))

setEPS()
  postscript(paste0("../plots/scRNAseq_analysis/scRNAseq_ViolinPlots_Itgb1_expression_HSC_age2.eps"), width = 8, height = 7)
...
# T test
t.test(data_adhesion$Adhesion[which(data_adhesion$Age_Cell_type == "Young_CD49b-")], data_adhesion$Adhesion[which(data_adhesion$Age_Cell_type == "Young_CD49b+")])
t.test(data_adhesion$Adhesion[which(data_adhesion$Age_Cell_type == "YA_CD49b-")], data_adhesion$Adhesion[which(data_adhesion$Age_Cell_type == "YA_CD49b+")])
...
annotation_HSCScore$Age <- factor(annotation_HSCScore$Age, levels = c("Young","YA","Old"))
...
setEPS()
postscript("../plots/scRNAseq_analysis/scRNAseq_Boxplot_HSCScore_all.eps", width = 10, height = 5)
  ggplot(annotation_HSCScore, aes(y = HSCScore, x = Age, fill = Cell_type)) +
  geom_boxplot(position = position_dodge(1), outlier.size = 0.5) +
  theme_classic() +
  scale_fill_manual(values = colours_Celltypes)
...
setEPS()
postscript("../plots/scRNAseq_analysis/scRNAseq_Boxplot_HSCScore_HSCs.eps", width = 10, height = 5)
  ggplot(annotation_HSCScore_main, aes(y = HSCScore, x = Cell_type, fill = Age)) +
  geom_boxplot(position = position_dodge(1), outlier.size = 0.5) +
  theme_classic() +
  scale_fill_manual(values = colours_Age)
...
HSCScore_x <- annotation_HSCScore %>% filter(Age_Cell_type == "Young_CD49b-") %>% {.$HSCScore} 
HSCScore_y <- annotation_HSCScore %>% filter(Age_Cell_type == "Young_CD49b+") %>% {.$HSCScore}
wilcox.test(HSCScore_x,HSCScore_y)

HSCScore_x <- annotation_HSCScore %>% filter(Age_Cell_type == "YA_CD49b-") %>% {.$HSCScore} 
HSCScore_y <- annotation_HSCScore %>% filter(Age_Cell_type == "YA_CD49b+") %>% {.$HSCScore}
wilcox.test(HSCScore_x,HSCScore_y)
...
rm(metadata_fetal, df_fetal_Li, RNA, temp, Gene_Ids_fetal)
```
...
setEPS()
postscript("../plots/scRNAseq_analysis/scRNAseq_Barplot_RF_CellType.eps", width=12, height=6)
  print(p)
dev.off()
...
cluster_distribution <- cluster_distribution %>%
  filter(Var3 %in% c("CD49b-", "CD49b+"))
cluster_distribution$CT_Age <- paste0(cluster_distribution$Var3,"_",cluster_distribution$Var2)
cluster_distribution$CT_Age <- factor(cluster_distribution$CT_Age, levels = c("CD49b-_Young","CD49b+_Young","CD49b-_YA","CD49b+_YA","CD49b-_Old","CD49b+_Old"))
...
setEPS()
postscript("../plots/scRNAseq_analysis/scRNAseq_Barplot_Fetal_CellType.eps", width=12, height=6)
  print(p)
dev.off()
...
setEPS()
postscript("../plots/scRNAseq_analysis/scRNAseq_Barplot_Herault_cluster.eps", width=12, height=6)
  print(p)
dev.off()
...
metadata_Grover$Age[which(metadata_Grover$Age == "young")] <- "YA"
metadata_Grover$Age[which(metadata_Grover$Age == "old")] <- "Old"
metadata_Grover$Age <- factor(metadata_Grover$Age, levels=c("Young","YA","Old"))
...
metadata_Mann$Age[which(metadata_Mann$Age %in% c("young", "young1", "young2", "young3"))] <- "YA"
metadata_Mann$Age[which(metadata_Mann$Age %in% c("old", "old2", "old3"))] <- "Old"
metadata_Mann$Age <- factor(metadata_Mann$Age, levels=c("Young","YA","Old"))
...
metadata_Kirschner$Age <- c(rep("Old", 96), rep("YA", 192), rep("Old", 96))
metadata_Kirschner$Age <- factor(metadata_Kirschner$Age, levels=c("Young","YA","Old"))
...
metadata_Kowalczyk$Age[grep("^young_LT_HSC_", metadata_Kowalczyk$name)] <- "YA"
...
combined.combined$Age <- factor(combined.combined$Age, levels = c("Young","YA","Old"))
...
setEPS()
postscript("../plots/scRNAseq_analysis/scRNAseq_UMAP_Luc_Svendsen_Age.v3.eps", width=12, height=4)
  DimPlot(combined.combined, reduction = "umap", group.by = "Age", shuffle = TRUE, split.by = "source", cols = colours_Age)
dev.off()
...
```{r}
Up_young <- read.table("../output_files/scRNAseq_analysis/scRNAseq_Up_in_young_padj0.01_logFC1.txt", header = TRUE)
...
colnames(temp_df) <- c("Up_young", "Up_old", "Age", "Study")

for(study in c("Mann","Grover","Luc","Kowalczyk","Kirschner")){
  all_studies[[study]] <- AddModuleScore(object = all_studies[[study]], features = list(rownames(Up_young)), name = 'Up_young', assay = "SCT")
  all_studies[[study]] <- AddModuleScore(object = all_studies[[study]], features = list(rownames(Up_old)), name = 'Up_old', assay = "SCT")
  temp <- data.frame(Up_in_young = all_studies[[study]]$Up_young1,
...
temp_df$Age <- factor(temp_df$Age, levels = c("Young","YA","Old"))
temp_df$Study <- factor(temp_df$Study, levels = c("Luc","Grover","Kowalczyk","Kirschner","Mann"))

p <- ggplot(temp_df, aes(y = Up_in_young, x = Study, fill = Age)) +
...
setEPS()
postscript("../plots/scRNAseq_analysis/scRNAseq_violin_Luc_Svendsen_Regions_Up_Young.v3.eps", width=9, height=6)
  print(p)
dev.off()
...
setEPS()
postscript("../plots/scRNAseq_analysis/scRNAseq_violin_Luc_Svendsen_Regions_Up_Old.v3.eps", width=9, height=6)
  print(p)
dev.off()

rm(all_studies, p, Up_young, Up_old, study, p, temp)
```
...
# Mann et al.
temp_A <- temp_df[which(temp_df$Study == "Mann" & temp_df$Age == "YA"),]
temp_O <- temp_df[which(temp_df$Study == "Mann" & temp_df$Age == "Old"),]
wilcox.test(x = temp_A$Up_in_young, y = temp_O$Up_in_young)
wilcox.test(x = temp_A$Up_in_old, y = temp_O$Up_in_old)

# Kirschner et al.
temp_A <- temp_df[which(temp_df$Study == "Kirschner" & temp_df$Age == "YA"),]
temp_O <- temp_df[which(temp_df$Study == "Kirschner" & temp_df$Age == "Old"),]
wilcox.test(x = temp_A$Up_in_young, y = temp_O$Up_in_young)
wilcox.test(x = temp_A$Up_in_old, y = temp_O$Up_in_old)

# Grover et al.
temp_A <- temp_df[which(temp_df$Study == "Grover" & temp_df$Age == "YA"),]
temp_O <- temp_df[which(temp_df$Study == "Grover" & temp_df$Age == "Old"),]
wilcox.test(x = temp_A$Up_in_young, y = temp_O$Up_in_young)
wilcox.test(x = temp_A$Up_in_old, y = temp_O$Up_in_old)

# Kowalczyk et al.
temp_A <- temp_df[which(temp_df$Study == "Kowalczyk" & temp_df$Age == "YA"),]
temp_O <- temp_df[which(temp_df$Study == "Kowalczyk" & temp_df$Age == "Old"),]
wilcox.test(x = temp_A$Up_in_young, y = temp_O$Up_in_young)
wilcox.test(x = temp_A$Up_in_old, y = temp_O$Up_in_old)

# Somuncular et al.
temp_A <- temp_df[which(temp_df$Study == "Luc" & temp_df$Age == "YA"),]
